...
// app.get("/api/DVFData/:departement", (req, res) => {
//   const code = req.params.departement;
//   const filePath = path.join(DVFDataFolder, `DVF_${code}.json`);

//   fs.readFile(filePath, "utf-8", (err, data) => {
//     if (err) {
//       console.error("Erreur de lecture fichier JSON :", err);
//       return res.status(404).json({ error: "Fichier introuvable." });
//     }

//     try {
//       const parsed = JSON.parse(data);
//       res.json(parsed); // plus safe que tout charger d'un coup
//     } catch (e) {
