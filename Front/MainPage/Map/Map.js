...
document.getElementById('toggleAmenityList').addEventListener('click', () => {
    ...
    if (amenityList.classList.contains('active')) {
        // Si la liste est active, la faire glisser vers la droite et la cacher
        ...
        // Si la liste n'est pas active, la faire glisser vers la gauche et la rendre visible
        amenityList.classList.remove('hidden');
        setTimeout(() => {
            amenityList.classList.add('active', 'slide-in');
        }, 0); // Assure que la classe 'hidden' est supprimée avant d'ajouter 'active'
    }
});
