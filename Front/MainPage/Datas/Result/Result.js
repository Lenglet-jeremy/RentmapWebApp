...
async function fetchCytiesClimat(cityName) {
    try {
        const response = await fetch(`http://localhost:5000/api/ClimatVilles`);
        const data = await response.json();
...
async function fetchCytiesUrbanisme(cityName) {
    try {
        const response = await fetch(`http://localhost:5000/api/Urbanisme`);
        const data = await response.json();
...
async function fetchCytiesGrandsAxes(cityName) {
    try {
        const response = await fetch(`http://localhost:5000/api/GrandsAxes`);
        const data = await response.json();
...
async function fetchDVFData() {
    ...
    try {
        const response = await fetch(`http://localhost:5000/api/DVFData/35`);
        const data = await response.json();
...
async function CreateCriminalityChart(canvasId, department, city, population, label, borderColor, cityInputId = null) {
    try {
        const response = await fetch(`http://localhost:5000/api/SecuriteCriminalite`);
        const statsNationnaleResponse = await fetch(`http://localhost:5000/api/StatsNationnale`);
        const data = await response.json();
...
async function fetchLoiLittoralData(department, city) {
    try {
        const response = await fetch(`http://localhost:5000/api/LoiLittoral`);
        const data = await response.json();
...
async function fetchZoneMontagnesData(department, city) {
    try {
        const response = await fetch(`http://localhost:5000/api/Montagnes`);
        const data = await response.json();
